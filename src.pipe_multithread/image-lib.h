 ...
 * Side-Effects: none
 *
 * Description: keeps reading from the pipe and applies the desired transformations
 *              to the input image and writes it in the desired folder
 *
 *****************************************************************************/
void* thread_func();
 ...
 * write_func()
 *
 * Arguments: struct with information needed to write on the pipe
 * Returns: 
 * Side-Effects:
 *
 * Description: writes everything needed to the pipe
 *
 *****************************************************************************/
void* write_func(void* defaults);

/* pipe */
extern int pipefd[2];

/* timing_n file */
extern FILE* timing_n;
